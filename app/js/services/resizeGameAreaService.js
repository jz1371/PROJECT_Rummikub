/**
 * File: app/services/resizeGameAreaService.js
 * -----------------------------------------------
 * @reference: http://yoav-zibin.github.io/emulator/resizeGameAreaService.js
 */
        ...
        function($window, $log) {
            ...
            function rescale() {
                ...
                //if (windowHeight > windowWidth) {
                    ...
                    //widthToHeight = (widthToHeight > 1) ? (1.0 / widthToHeight) : widthToHeight;
                //} else {
                    //widthToHeight = (widthToHeight < 1) ? (1.0 / widthToHeight) : widthToHeight;
                //}
                ...
                gameArea.style.marginRight= '' + marginLeft + 'px';
                gameArea.style.position = "absolute";
                gameArea.style.left = "50%";
                gameArea.style.right= "50%";
